    ...
    <div className="w-full lg:mt-[7rem] mt-0 lg:h-[40rem] h-[30rem]">
       ...
       <div className="relative lg:top-[-23rem] top-[-11rem] w-full lg:pr-10 pr-4">
            <div className="flex flex-row justify-between w-full items-center gap-5 lg:pr-16 lg:pl-20 pl-0 px-6 ">
                ...
                <button className="flex flex-row-reverse justify-between items-center text-white w-[8rem] pl-5 lg:pl-0" type="button"> <IoIosArrowBack className="text-white text-[24px]"/> <span className="text-[18px] lg:block hidden">مشاهده همه</span> </button>
            </div>
            <Swiper slidesPerView={'auto'} spaceBetween={30} className="MySwiper mt-12">
                <SwiperSlide className={styles.SwiperSlider}> <PopularCompaniesCard cover="ImagePopularCompanies1.png" avatar="snapp.jpg" title="شرکت اسنپ" description="از درخواست خودرو گرفته تا سفارش غذا، خرید سوپرمارکتی ، خرید بلیط سفر، مشاوره پزشکی و روانی..." star="5" ContactCount="21,394" invesmentCount="398"/> </SwiperSlide>
