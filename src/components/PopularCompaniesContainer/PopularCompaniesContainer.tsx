...
export default function PopularCompaniesContainer() {
  return (
    <div className="flex flex-col justify-center items-center w-full lg:mt-[15rem] mt-40 lg:h-[40rem] h-[30rem]">
       ...
       <div className="flex flex-col justify-center items-center relative lg:top-[-23rem] top-[-11rem] w-full lg:px-10 px-4">
            ...
            <Swiper slidesPerView={"auto"} spaceBetween={30} className="mt-14">
